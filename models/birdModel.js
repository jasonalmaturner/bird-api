...
var birdSchema = new mongoose.Schema({
  ...
  scientificName: { type: String, sparse: true, unique: true, require: true },
  ...
  SISRecID: { type: Number, sparse: true, unique: true },
  SpcRecID: { type: Number, sparse: true, unique: true }
});
